...
export const dataAboutUs = [
  ...
  },
  {
    ...
    description:
      "Nos comprometemos a ofrecer resultados de la más alta calidad en cada  proyecto. Desde el diseño de la landing page más pequeña hasta la  estrategia de branding completa, nos esforzamos por la excelencia en cada detalle para que tu marca se destaque.",
  },
  {
    id: "3",
